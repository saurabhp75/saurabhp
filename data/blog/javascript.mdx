...
- `Variable environment/memory`: It has key value pairs of variables and functions.
- `Thread of execution`:
...
length in itemList ? console.log('This will be printed') : console.log('This should not print')
```
